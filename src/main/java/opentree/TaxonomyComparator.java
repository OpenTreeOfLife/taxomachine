...
//				System.out.println(innode.getProperty("name"));
	...
	public static void main(String[] args) {
		String graphdb1 = "";
		String graphdb2 = "";
	    GraphDatabaseAgent graphDb1 = new GraphDatabaseAgent(graphdb1);
	    GraphDatabaseAgent graphDb2 = new GraphDatabaseAgent(graphdb2);
	    TaxonomyComparator tc = new TaxonomyComparator();
//	    tc.setDominantTaxonomy(graphDb1);
	}
