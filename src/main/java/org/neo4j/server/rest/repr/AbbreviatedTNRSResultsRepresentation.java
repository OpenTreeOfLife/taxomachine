...
public class AbbreviatedTNRSResultsRepresentation extends MappingRepresentation {

	public AbbreviatedTNRSResultsRepresentation(RepresentationType type) {
		super(type);
	}

	AbbreviatedTNRSResultsRepresentation(String type) {
		super(type);
	}
	 ...
	 * @return
	 */
	public static AbbreviatedTNRSResultsRepresentation getResultsRepresentation(
			final TNRSResults results) {
		return new AbbreviatedTNRSResultsRepresentation(RepresentationType.MAP.toString()) {
