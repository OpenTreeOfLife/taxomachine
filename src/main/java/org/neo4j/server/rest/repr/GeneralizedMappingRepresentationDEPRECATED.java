...
public class GeneralizedMappingRepresentationDEPRECATED extends MappingRepresentation {

    public GeneralizedMappingRepresentationDEPRECATED(RepresentationType type) {
        super(type);
        // TODO Auto-generated constructor stub
    }

    public GeneralizedMappingRepresentationDEPRECATED(String type) {
        super(type);
    }
